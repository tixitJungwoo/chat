...
/* globals emojisByCategory:true, emojiCategories:true, toneList:true */ /*                                       // 1
                                                                          ...
                                                                          */emojiCategories = {                   //
	people: TAPi18n.__('Smileys_and_People'),                                                                        // 7
	nature: TAPi18n.__('Animals_and_Nature'),                                                                        // 8
	food: TAPi18n.__('Food_and_Drink'),                                                                              // 9
	activity: TAPi18n.__('Activity'),                                                                                // 10
	travel: TAPi18n.__('Travel_and_Places'),                                                                         // 11
	objects: TAPi18n.__('Objects'),                                                                                  // 12
	symbols: TAPi18n.__('Symbols'),                                                                                  // 13
	flags: TAPi18n.__('Flags')                                                                                       // 14
};                                                                                                                // 6
toneList = {                                                                                                      // 17
	'raised_hands': 1,                                                                                               // 18
	'clap': 1,                                                                                                       // 19
