...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////    // 3
//                                                                                                               //    // 4
// packages/mystor:device-detection/device_detection.js                                                          //    // 5
//                                                                                                               //    // 6
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////    // 7
                                                                                                                 //    // 8
(function() {                                                                                                    // 1  // 9
  var Device = function() {                                                                                      // 2  // 10
    // Constructor                                                                                               // 3  // 11
    this._deps = new Deps.Dependency;                                                                            // 4  // 12
    this._type = 'desktop';                                                                                      // 5  // 13
                                                                                                                 // 6  // 14
    this._suffix_deps = {                                                                                        // 7  // 15
      tv: new Deps.Dependency,                                                                                   // 8  // 16
      tablet: new Deps.Dependency,                                                                               // 9  // 17
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////    // 258
//                                                                                                               //    // 259
// packages/mystor:device-detection/device_helpers.js                                                            //    // 260
//                                                                                                               //    // 261
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////    // 262
                                                                                                                 //    // 263
if (typeof UI !== 'undefined') {                                                                                 // 1  // 264
  /*                                                                                                             // 2  // 265
   * Template Rendering Shortcut                                                                                 // 3  // 266
   */                                                                                                            // 4  // 267
  UI.registerHelper('deviceRender', function() {                                                                 // 5  // 268
    var name = this;                                                                                             // 6  // 269
    if (! _.isString(name)) {                                                                                    // 7  // 270
      // If meteor-router is installed, no passed name will load Meteor.Router.page()                            // 8  // 271
      if (typeof Meteor.Router !== 'undefined') {                                                                // 9  // 272
